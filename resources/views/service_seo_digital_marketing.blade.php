...
<head>
    ...
    <title>Seo - Digital Marketing  | Mavensdesk Technology Services</title>
...
<body data-spy="scroll" data-target="#bs-example-navbar-collapse-1" data-offset="90">
    ...
    <!--================Header Area =================-->
    <header class="dash_tp_menu_area" style="background-color: #000;">
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="nav-link dropdown-toggle" href="#" id="services" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Services
                      </a>
            ...
            <div class="row g_head_inner">
                ...
                <div class="col-md-5">
                    <div class="g_right_side">
                        ...
                        <h4>How we help</h4>
                        <p>Our search engine optimization services are unique to the industry with verifiable results. As we continually keep up with the fluctuating algorithm of Google. We’ve positioned ourselves as the gold standard in search engine optimization. We will help youtube modify your website in such a way that it is more visible on a search engine in its organic search result.</p>
                        <h3></h3>
