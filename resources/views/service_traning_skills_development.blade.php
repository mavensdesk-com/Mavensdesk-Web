...
<head>
    ...
    <title>Training and Skill Development  | Mavensdesk Technology Services</title>
...
<body data-spy="scroll" data-target="#bs-example-navbar-collapse-1" data-offset="90">
            ...
            <div class="row g_head_inner">
                ...
                <div class="col-md-5">
                    <div class="g_right_side">
                        <h5>Training and Skill Development</h5>
                        <h4>How we help</h4>
    ...
    <section class="gadget_feature_area" id="feature">
        <div class="container">
            <div class="gd_title">
                <h2 data-title="Mavensdesk">What we do in our Training and Skill Development</h2>
            </div>
