...
<section class="partners_logo_area" id="clients" style="background-color: #fff;">
    ...
    <div class="partners_logo_slider owl-carousel">
        ...
        <div class="item">
            <img src="img/clients/Cognizant.png" alt="Cognizant">
        </div>
        <div class="item">
        ...
        <div class="item">
            <img src="img/clients/Nokia.png" alt="Nokia">
        </div>
        <div class="item">
            <img src="img/clients/Airbus.png" alt="Airbus">
        </div>
        <div class="item">
            <img src="img/clients/Unisys.png" alt="Unisys">
        </div>
        <div class="item">
